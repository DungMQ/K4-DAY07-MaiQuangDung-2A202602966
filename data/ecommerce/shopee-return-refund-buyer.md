---
doc_id: "shopee-return-refund-buyer"
...
> *(Ghi chú tách tài liệu: trang nguồn gộp quy định cho cả hai bên trên cùng một URL. Theo `docs/DATA_COLLECTION.md`, mục 5 (Quyền của Người Bán) và mục 7 (Trách nhiệm chi phí vận chuyển của Người Bán) đã được tách sang `shopee-return-refund-seller.md` để `search_with_filter()` có việc thật để lọc — vì vậy số hiệu mục ở file này nhảy từ 4 sang 6 và từ 6 sang 8. Cả hai file dùng chung `source_url`.)*
